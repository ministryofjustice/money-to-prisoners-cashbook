...
CASHBOOK_FOOTER_FEEDBACK_LINK = os.environ.get('CASHBOOK_FOOTER_FEEDBACK_LINK', None)
DISBURSEMENTS_FOOTER_FEEDBACK_LINK = os.environ.get('DISBURSEMENTS_FOOTER_FEEDBACK_LINK', None)
