...
from core.testing.testcases import MTPTestCase


class DashboardViewTestCase(MTPTestCase):
    ...
    def __call__(self, result, mocked_api_client, *args, **kwargs):
        ...
        super(MTPTestCase, self).__call__(result, *args, **kwargs)
    ...
    def test_0_available_0_pending(self):
        self.login()
    ...
    def test_some_available_0_pending(self):
        self.login()
    ...
    def test_0_available_some_pending(self):
        self.login()
    ...
    def some_available_some_pending(self):
        self.login()
