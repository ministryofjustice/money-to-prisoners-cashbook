...
urlpatterns = [
    ...
    re_path(
        ...
        views.RecipientPostcodeView.as_view(),
        name=views.RecipientPostcodeView.url_name),
    re_path(
        r'^recipient_address/$',
        views.RecipientAddressView.as_view(),
    ...
    re_path(
        r'^remittance_description/$',
        views.RemittanceDescriptionView.as_view(),
    ...
    re_path(
        r'^clear/$',
        views.CreatedView.clear_disbursement,
        name='clear_disbursement',
    ),

    # confirmation flow
    re_path(
        r'^pending/$',
        views.PendingListView.as_view(),
        name=views.PendingListView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/$',
        views.PendingDetailView.as_view(),
        name=views.PendingDetailView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/reject/$',
        views.RejectPendingView.as_view(),
        name=views.RejectPendingView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/sending_method/$',
        views.UpdateSendingMethodView.as_view(),
        name=views.UpdateSendingMethodView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/prisoner/$',
        views.UpdatePrisonerView.as_view(),
        name=views.UpdatePrisonerView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/amount/$',
        views.UpdateAmountView.as_view(),
        name=views.UpdateAmountView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/recipient_contact/$',
        views.UpdateRecipientContactView.as_view(),
        name=views.UpdateRecipientContactView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/recipient_address/$',
        views.UpdateRecipientAddressView.as_view(),
        name=views.UpdateRecipientAddressView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/recipient_bank_account/$',
        views.UpdateRecipientBankAccountView.as_view(),
        name=views.UpdateRecipientBankAccountView.url_name,
    ),
    re_path(
        r'^pending/(?P<pk>\d+)/remittance_description/$',
        views.UpdateRemittanceDescriptionView.as_view(),
    ...
    re_path(
        r'^process-overview/$',
        views.ProcessOverview.as_view(),
        name=views.ProcessOverview.url_name,
    ),
    re_path(
        r'^track-invoice/$',
        views.TrackInvoice.as_view(),
        name=views.TrackInvoice.url_name,
    ),
    re_path(
        r'^kiosk-instructions/$',
        views.KioskInstructions.as_view(),
        name=views.KioskInstructions.url_name,
    ),

    re_path(
        r'^feedback/$',
        views.DisbursementGetHelpView.as_view(),
        name=views.DisbursementGetHelpView.url_name,
    ),
    re_path(
        r'^feedback/success/$',
        views.DisbursementGetHelpSuccessView.as_view(),
